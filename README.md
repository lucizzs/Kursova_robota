...
- **Коментарі** до задач
- **Теги** з кольорами для категоризації задач
...
- **Багатошарова архітектура** — чіткий поділ Controller → Service → Repository
- **Dependency Injection** через composition root, без рантайм-контейнерів
- **DTO + Zod-валідація** усіх вхідних даних
- **Типізовані доменні помилки** (AppError, NotFoundError, ConflictError тощо)
- **Security headers** (Helmet з CSP), CORS, bcrypt для паролів
