/**
 * Composition Root — місце, де збираються всі залежності.
 * Це єдиний файл, який знає про конкретні реалізації всіх сервісів.
 * Інші модулі залежать лише від інтерфейсів через конструктори.
 */
